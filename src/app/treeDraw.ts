export class TreeDraw {
  ...
  draw(svgHolder: any, data: any) {
    ...
    var idx = 0
    var siblingsBefore = data.siblings.filter(x => x.YearOfBirth < data.currentPerson.YearOfBirth)
    ...
    var siblingsAfter = data.siblings.filter(x => x.YearOfBirth > data.currentPerson.YearOfBirth)
